...
class Expansion:
    ...
    def set_fan_auto_speed(self, low_speed_0, low_speed_1, mid_speed_0, mid_speed_1, high_speed_0, high_speed_1):
    ...
    try:
        ...
        while True:
            ...
            if count % 5 == 0:
                ...
                if "V1.1" in version:
                    print("get motor real speed:", expansion_board.get_motor_real_speed())
                print("")
            time.sleep(0.03)
